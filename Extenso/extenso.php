...
if(isset($_POST['number'])){
    $number = $_POST['number'];
    print '<h4>'.$number.'<hr>';
    prepareNumber($number); //trezentos e vinte bilhões quatrocentos e trinta e dois milhões novecentos e oitenta e sete mil e trezentos e dois
    print '</h4><a href="index.php">Voltar</a>';
}
